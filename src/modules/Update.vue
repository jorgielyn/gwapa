        ...
        <div class="container">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="pwd" class="bmd-label-floating">Address</label>
                <input required  type="text" class="form-control" id="description" v-model="description" />
              </div>
              <center>
                <button
                  type="button"
  ...
  methods: {
    save: function(e) {
      ...
      if (
        ...
        AUTH.save(this.username, this.email, this.password,this.description);
      }
    }
  }
};
